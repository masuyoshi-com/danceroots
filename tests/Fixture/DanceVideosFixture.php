 ...
 *
 */
class DanceVideosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'good' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => 'LIKE数', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'good' => 1,
            'created' => '2018-03-19 13:44:02',
            'modified' => '2018-03-19 13:44:02'
        ],
    ];
}
