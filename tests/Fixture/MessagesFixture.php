...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'to_user_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '相手ユーザーID', 'precision' => null, 'autoIncrement' => null],
        ...
        'read_flag' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '既読フラグ', 'precision' => null],
        'returned_flag' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '返信済みフラグ', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'read_flag' => 1,
            'returned_flag' => 1,
            'created' => '2018-03-25 09:00:57',
            'modified' => '2018-03-25 09:00:57'
        ],
    ];
}
