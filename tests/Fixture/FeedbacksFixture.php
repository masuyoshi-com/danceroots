...
class FeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subject' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '件名', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-05-06 09:57:47',
            'modified' => '2018-05-06 09:57:47'
        ],
    ];
}
