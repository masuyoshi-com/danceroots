...
class TeamsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'ユーザID', 'precision' => null, 'autoIncrement' => null],
        'name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'チーム名', 'precision' => null, 'fixed' => null],
        'youtube' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'チーム動画', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-03-18 11:16:51',
            'modified' => '2018-03-18 11:16:51'
        ],
    ];
}
