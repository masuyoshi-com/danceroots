...
class GeneralsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '名前', 'precision' => null, 'fixed' => null],
        'pref' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '都道府県', 'precision' => null, 'fixed' => null],
        ...
        'favorite_genre' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '好きなジャンル', 'precision' => null, 'fixed' => null],
        'favorite_dancer' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '好きなダンサー', 'precision' => null, 'fixed' => null],
        'favorite_artist' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '好きなアーティスト', 'precision' => null, 'fixed' => null],
        ...
        'notes' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'メモ・ノート', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'favorite_genre' => 'Lorem ipsum dolor sit amet',
            'favorite_dancer' => 'Lorem ipsum dolor sit amet',
            ...
            'created' => '2018-04-13 08:50:35',
            'modified' => '2018-04-13 08:50:35'
        ],
    ];
}
