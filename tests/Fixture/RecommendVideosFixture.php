...
/**
 * RecommendVideosFixture
 *
 */
class RecommendVideosFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '自動採番ID', 'autoIncrement' => true, 'precision' => null],
        'title' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'タイトル', 'precision' => null, 'fixed' => null],
        'youtube' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'Youtube', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-09 09:51:22',
                'modified' => '2018-07-09 09:51:22'
            ],
        ];
        parent::init();
    }
