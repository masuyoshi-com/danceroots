...
class InformationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'お知らせタイトル', 'precision' => null, 'fixed' => null],
        'body' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'お知らせ内容', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-05-31 10:28:56',
            'modified' => '2018-05-31 10:28:56'
        ],
    ];
}
