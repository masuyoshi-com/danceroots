<?php $this->assign('title', 'プロフィール内イベント編集') ?>
        ...
        <div class="d-flex">
            <div>
                <h5 class="h5-responsive font-weight-bold dark-grey-text">
                    <span class="none">Profile </span>Events/Workshop<i class="fa fa-pencil pink-text ml-2" aria-hidden="true"></i>
                </h5>
            </div>
            <div class="ml-auto">
                <p class="m-0 grey-text"><small><span class="none">プロフィール内</span>イベント編集</small></p>
            </div>
        </div>
        <hr class="mt-0 mb-1">
