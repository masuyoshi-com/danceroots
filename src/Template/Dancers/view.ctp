...
<div class="row">
    ...
    <div class="col-lg-8 col-md-12 mt-3 mb-3">
...
<div class="card card-cascade narrower mb-3 mt-4">

    <div class="view gradient-card-header mdb-color lighten-2">
        <h5 class="mb-0 font-bold"><?= h($dancer->name) ?> Profile</h5>
    </div>
        ...
        <div class="row">
            <?php if ($dancer->facebook) : ?>
                <div class="col-lg-6 col-md-6 col-xs-12">
                    ...
                    <div class="md-form">
                        <?= $this->Form->control('test', ['class' => 'form-control']) ?>
                    </div>
                </div>
            <?php endif; ?>
            <?php if ($dancer->twitter) : ?>
                <div class="col-lg-6 col-md-6 col-xs-12">
                    ...
                    <div class="md-form">
                        ...
                        <?= $this->Html->link('', h($dancer->twitter) . '?ref_src=twsrc%5Etfw', ['class' => 'twitter-timeline']) ?>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="col-lg-12 text-center">
            <?php
                if ($dancer->user_id === $logins['id']) {
                    print $this->Html->link('プロフィールを編集する', ['action' => 'edit', h($dancer->user_id)], ['class' => 'btn btn-primary btn-block']);
                } else {
