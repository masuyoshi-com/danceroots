...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                勘違いしないでほしいのは、「反抗するべきだ」と言っているわけではありません。<strong class="font-weight-bold">フラットな目を持つことが大切だ</strong>と述べているのです。
            </p>
            <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">好きなインストラクターを目標にして良いが、最終目標ではないことに気づいておく。</li>
