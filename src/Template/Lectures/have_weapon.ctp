...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ストリートダンサーとして深みを増すためにはダンスだけに捉われるのではなく、HipHop文化自体の触れることが重要というお話は前回しました。
            </p>
            <p>
                それ以外にもできることなら、将来を見据え、人として「もう一つ武器」を持つことをお勧めします。武器というのは何か技術的なこと、また、それで生活ができるレベルまで身に付けることです。
            </p>
            <p>
                好きなことだけで生活ができるのは幸せなことです。今はインターネットも確立され、様々なサービスが生まれ、好きなことで生きていく(<small>YouTuberではありませんが</small>)人が認められる世の中になりつつもあります。
            </p>
            <p>
                この傾向は今後もっと増えていくでしょうし、増えていくべきだと筆者は考えています。筆者自身も今まで培ってきたことの技術や意思がこのDancerootsというサービスに注がれ、皆に貢献していけるように、価値を認めてもらえるように努力し続ける必要があるわけです。<br>
            ...
            <p>
                真っすぐにプロのストリートダンサーとして生活するために、一つの事に集中することを否定しているのではありません。一つの夢や目標を達成しつつ、満足せず、常に自分磨きを怠らずに新しいことを吸収していくことが大切です。若い時はそれが何を意味するのかよくわかりませんでしたが、今では「なるほど、そうだな」と思います。
            </p>
            <p>
