...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                ダンス活動が忙しくなると、中々自分一人の練習の時間を割くことが難しくなります。もしダンスインストラクターのみで生活できているのであれば、まだ時間があるかもしれませんが、別の職業などで生活の糧としている場合は尚忙しいでしょう。
            </p>
            <p>
            ...
            <p>
                一人の時間のダンス練習で、自分の精神面や満足度がリセットできれば、仲間と集まって練習する際にも要領よくルーティンを考えやすくなります。また、考え込んでいた部分をふとクリアできることも多いでしょう。
            </p>
            <p>
