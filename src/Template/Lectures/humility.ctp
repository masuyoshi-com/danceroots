...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ストリートダンスが上達するにつれ、徐々に自信が心の中に沸いてくるものです。「ダンスが上手い」ということは、自分が自信をもって人に言える「得意分野がある」ということです。
            </p>
            <p>
            ...
            <p>
                たくさんの困難があっても乗り越え、一緒にダンスチームとして練習し、苦楽を共にしていくことは大変です。継続して活動していくことは簡単ではありません。それらは尊敬に値することです。
            </p>
            <p>
                ダンス仲間の中に傲慢な人がいれば崩壊に向かう可能性があります。指摘できる人間関係を築けるかどうかは自分自身に掛かっていると考えましょう。皆で助け合って、常に謙虚にふるまえるよう努力すべきです。
            </p>
            <p>
                一つの分野の実力があり、人に認められると不思議と変貌する人は多いです。あなたはこのことに気づき、<strong class="font-weight-bold">本当はそこからがスタートだということを忘れてはいけません</strong>。
            </p>
            <p>
                少し広い目で考えてみれば、特定の分野が得意であっても、一歩違う世界へ足を踏み入れれば、誰でも素人です。たくさんの人々が得意なこと、色んな世界で仕事をしているからこそ今日の社会が回っていることを自覚しましょう。
            </p>
            <p>
                一度溝にはまってしまうと、せっかくあなたの資源(<small>大切な時間)</small>を一生懸命に捧げて努力してきたダンスを諦めてしまいかねない事態になります。どんな時でも初心を忘れず、謙虚であることを心掛けましょう。
            </p>
        </div>
    </div>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">「得意分野がある」ということはあなたの自信につながる。だが自信過剰にならないように注意すべき。</li>
        <li class="list-group-item">ダンスはチームとして成り立つ場合がほとんど。まず自分のチームを大切にできるかどうかが重要である。</li>
