...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ダンス活動を続けていく中で、ダンスインストラクターとしての話をいただく場合があります。インストラクターとしてのオファーが来るということは、あなたは少なくともその先方に「認められつつある」ということを自覚することです。
            </p>
            <p>
            ...
            <p>
                それらのプログラムをあなたが自由に考え、実行しても良い権限があるのです。それを行うことはストリートダンサーとして絶好の上達の機会です。
            </p>
            <p>
