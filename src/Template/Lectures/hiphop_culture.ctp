...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                内容が濃い、深みがある、または個性のあるストリートダンサーになるために必要な要素はダンスが上手いだけではいけません。これまでも話してきたようにHipHop文化の知識・教養が必要です。
            </p>
            <p>
                「好きこそ物の上手なれ」という言葉がありますが、ストリートダンスが好きなら、HipHop文化にも自然と興味が沸くはずです。
            </p>
            <p>
                ストリートダンス界は「ダンスが好き」というだけの人が多い印象があります。ストリートダンスが好きなのは土台として、他の教養を得るキッカケだと考えましょう。
            </p>
            <p>
                ダンス上級者になれば、<strong class="font-weight-bold">頭脳などの感覚的な許容の幅が広がるため、もっとたくさんの知識を吸収できるようになります</strong>。練習だけに終われる日々はクリアしているはずです。それなら自身のリソース(<small>資源</small>)はダンサーとしての深みに行くために使いましょう。
            </p>
            <p>
                最初の頃に好きだったものが年月が過ぎて、物を見るセンスも上達しているはずです。もっと高みを目指すために、HipHopの他の要素にも触れるようにしてください。
            </p>
            <p>
                例えば、筆者はダンスの先輩2人に同じチームとして活動させてもらっていた時期があります。DJ機器は全員持っていましたし、先輩2人に関してはMixTapeを販売していたり、クラブDJとしても活動していました。
                DJやラッパーの繋がりも強かったように思います。HipHopの違う要素で活動する人達からも良い刺激を受けることができますし、教養を得ることができるのです。
            </p>
            <p>
