...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                「今日は友達と遊びに行くから練習は休みにしておこう。」<br>
                「気持ちが乗らないし、家でゆっくりしたいから、まあいいか。」
            </p>
            <p>
                こういった気持ちは誰にでもあるものです。ここで重要になるのが<strong class="font-weight-bold">ダンスの練習を一つの自分の生活習慣として馴染ませることができるかどうか</strong>です。
            </p>
            <p>
            ...
            <p>
                どこかであなたがダンスの練習を(<small>努力の</small>)習慣化させる大切さに気づいていないと、一人になった時など、中々スムーズに練習をすることができないでしょう。
            </p>
            <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">自分が決めた練習時間(<small>スケジュール</small>)はそう簡単に変更すべきではない。</li>
        <li class="list-group-item">習慣化された努力は継続的で、精神的にも楽。できるだけ早くから身に付けること。</li>
