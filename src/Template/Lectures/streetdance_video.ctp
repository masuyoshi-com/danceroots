...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                昔であればVHSビデオテープを流しながら、目的のダンスショーを全部コピーして練習材料にしていました。現在ではYouTubeなどで数多くのストリートダンス動画があります。練習材料としては申し分ないでしょう。
            </p>
            <p>
            ...
            <p>
                一度ターゲットを決めたら、そのダンサーの癖もある程度は「まね」できるようになりましょう。実際、自分の癖になるまでやり続ける必要はありません。物まねができるということは、<strong class="font-weight-bold">あなたの動きの幅が大きく増える</strong>ということです。
            </p>
            <p>
                ただし、間違っても、そのダンサーになりきろうとは思ってはいけません。バランスをとるために、好む、好まないは別に自分が難しいと感じる対象をコピーすることも大切です。
            </p>
            <p>
            ...
            <p>
                筆者がオススメするのは、オールド・ミドルスクールです。<strong class="font-weight-bold">ストリートダンスの原点をコピーしていくことが、体に基礎と教養をもたらします。</strong>
            </p>
            <p>
            ...
            <p>
                ですが、間違いなくストリートダンスの歴史の教養はあなたのためになります。例外はありますが、現在のトップダンサー達は何かしらの形でそれらを学んでいることは間違いないでしょう。
            </p>
        </div>
    </div>
