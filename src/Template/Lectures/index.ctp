...
<section class="magazine-section my-4 pt-4">
    <h3 class="h3-responsive font-weight-bold text-center my-4">
        <i class="fa fa-book" aria-hidden="true"></i> <span class="none">読んで学ぶ</span>Webストリートダンス講座
    </h3>
    ...
    <p class="w-responsive mx-auto">
        この読んで学ぶWEBストリートダンス講座はそうした悩みを少しでも解決する手助けができればという思いで筆者が経験を交えて記事にしています。世の中には同じ人が二人いないように、不思議とダンスにおいてもあなたと同じスタイルを持つ人は本当はいないものなのです。
    </p>
    <p class="w-responsive mx-auto">
        要はそれに気づき、スタイルを掴むまで努力できるかどうか。そこに全てが掛かっているといっても過言ではありません。読むだけではダンスは上達しません。ですが、意識を変えることは可能です。ダンスの練習も、ショータイムも「意識、意志」の違いで人との違いを出すことができると考えています。
    </p>
    <p class="w-responsive mx-auto">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-md-0 mb-5">
            <div id="contents-2" class="single-news mb-3">
                ...
                <div class="d-flex justify-content-between">
                    <div class="col-11 text-truncate pl-0 mb-3">
                        <?= $this->Html->link('ルーティン・バリエーションを考える', ['action' => 'variation'], ['class' => 'font-weight-bold']) ?>
                    </div>
                    <a><i class="fa fa-angle-double-right"></i></a>
                </div>
            </div><!-- /.single-news -->
