...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                時間と共に環境は変わります。これは誰も避けることができません。<strong class="font-weight-bold">環境がどう変わってもあなたの信念が揺るがなければ、ストリートダンサーとしての道は必ず開かれていくでしょう。</strong>
            </p>
            <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">自由に自分の時間を使える環境であるならば、それは当たり前ではないことに気づき、その環境に感謝する。</li>
        <li class="list-group-item">周りのダンサーがやめていっても、あなたはダンスを続けられる意思があるか試される時は必ず来る。</li>
