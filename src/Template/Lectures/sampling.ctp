...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                そうした中で自分の動き(<small>ダンス</small>)として、使えるもの、使えないものの判断ができるようになります。あなたが「使えるもの」として判断した動きがあなたのダンスセンスです。
            </p>
            <p>
                特にダンスショーの時など、<br>
                <br>
                ...
                「こういうものが好きなんだな」<br>
                <br>
                ということを見ている人に伝えることができるかどうかが重要です。<br>
            </p>
            <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">ダンスの練習は基礎を中心にして、徐々にたくさんの動きをサンプリングしていくこと。</li>
        <li class="list-group-item">自分にとって、使える動き・使えない動きの判断が正しくできるまで研究をやめないこと。</li>
