...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        ...
        <p>
            もし、あなたが一人でストリートダンスを始め、今は動画などを研究しているとすれば、まずは<strong class="font-weight-bold">ダンス仲間を探すこと</strong>が先決です。
        </p>
        <p>
            なぜなら初期の段階から一人でダンス活動をしていくことは不可能に近いからです。まずダンスチームを組めません。ソロでバトルのみ出場、または舞台ダンサーという手もあるでしょうが、やはりチームに所属している方が大半でしょう。
        </p>
        <p>
            ストリートダンスだけに捉われず「仲間」という存在はあなたに色んな影響を与えます。悩んだ時は助け合い、また、良きライバルとしてお互いを高め合える存在になりやすいでしょう。
        </p>
        <p>
            人間関係のもつれも時にはあるでしょうが、そのデメリット(<small>デメリットも後にメリットになることばかり</small>)よりもメリットの方が確実に多いと断言できます。
        </p>
        <p>
            もし、一人でダンスをしているのなら、近隣でサークルを探す、もしくはスタジオに習いにいけば、自然と知り合いや友人ができるものです。
        </p>
        <p>
            ちなみに筆者は学生の頃に友達の影響でストリートダンスを始めました。なので自然に仲間はいましたし、一緒に練習をしていました。
        </p>
        <p>
            過去を振り返っても、やはり一人でダンスをするということは考えにくいことだと思います。学生時代にダンスを始めることは社会人になってからよりも、最初から友達がいるというメリットが大きいです。
        </p>
        <p>
            あなたがダンス初心者であれば、ダンス仲間はこの先何年にもわたって支え合えることができる存在です。
        </p>
        <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">最初からダンス活動を一人で行うのは大変難しい。ダンスチームも組むことができない。</li>
