...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                ダンス中級者を逸脱するためは、「人に教える」ということも覚えなければいけません。自分が人に教えているようで、実は自分が勉強になっていることがほとんどだからです。
            </p>
            <p>
            ...
            <p>
                ダンス初心者に教えることは大抵は基礎からでしょう。その基礎を細かく教えていく内に、それを言葉で説明することも多いはずです。
            </p>
            <p>
                ダンスの動きを言葉で説明する時に、<br>
                <br>
            ...
            <p>
                自分の言葉で動きを説明していく内にあなた自身も、より深く教えた事柄を理解するようになり、基礎が確固たるものになって覚えていきます。
            </p>
            <p>
            ...
            <p>
                教えてもらう側の人はダンスを教えてもらっても、<strong class="font-weight-bold">結局はそれを自分の物にできるかどうかは自分次第</strong>です。
            </p>
            <p>
                教える側の人は元々それだけの練習を積んできているはずですので、人に教えることによって、それが確固たる物になり、ダンス上達につながるのです。
            </p>
        </div>
    </div>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">人に教えているようで、実は自分が勉強になっている場合がほとんどだということに気付く。</li>
