...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                それが中級以上になってくると、ある程度動き(<small>ダンス</small>)が出来るのが自然で、目に見えて成果が感じにくくなるため、伸び悩む状態になるのかもしれません。
            </p>
            <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">上手くなったかどうかが問題ではなく、着実に努力できているかどうかが重要であることに気づく。</li>
    </ul>
