...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ストリートダンサーである以上、やはり人前に出て、ダンスショーケースで自分を見せたい(<small>表現したい</small>)のは当然でしょう。むしろ、ダンスが好きで有名になりたい気持ちもあって当然ですし、日陰ばかりでは楽しさも半減しかねません。
            </p>
            <p>
            ...
            <p>
                DJは音楽に詳しいのが普通です。たくさんの知識を共有することができます。
                また、音源を作る際には、<strong class="font-weight-bold">起承転結をつけるよう</strong>に意識してください。<small><span class="red-text">※</span>これも意外と出来る人少ないです。</small>
            </p>
            <p>
            ...
            <p>
                イメージが思い浮かぶまでに、自分達は「これが好き」というものがありますか？<strong class="font-weight-bold">何かをベースに取り組むこと</strong>はとても大切です。
            </p>
            <p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">コンテストなどの挑戦は最初の内は誰でも失敗する。だが、失敗することで得られることも多い。</li>
