...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                ですが、毎日の練習はいずれマンネリ化を起こす時が来ます。それと同時に伸び悩む時期が来たりします。「伸び悩む時期がきた」ということは、「前に進んできた」ということを覚えておいてください。そして、ダンス中級者になる頃に必ず勉強し、吸収しておきたいことは、<br>
                <br>
            ...
            <p>
                <strong class="font-weight-bold">「ダンスが上手であることと、かっこいいこと、インパクトがあること」は全く別の話です。</strong>
            </p>
            <p>
