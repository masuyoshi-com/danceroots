...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                ダンス上級者になるにつれ、最終的に行き着くスタイルを掘り続ければ良い時期がきますが、偏ったものしか見ていない人、見るべきものを見ていない人は、やはり学んでいる人より不利になるでしょう。
            </p>
            <p>
                誤解を恐れなく言えば、ダンスを始めた初心者の内は沢山のストリートダンサーを見ていても、本当に見るべきものは自然と絞られていくものです。<small><span class="red-text">※</span>絞られる対象も個人のセンスによります。</small>
            </p>
            <p>
