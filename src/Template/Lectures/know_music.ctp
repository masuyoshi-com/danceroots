...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ストリートダンスはHipHopの三大要素(<small>現在は4大要素 - MC、DJ、ブレイクダンス、グラフィティ</small>)の一つです。
                <small>
            ...
            <p>
                ですが、多くのストリートダンサー達は「ダンスが好き」または「ダンス界が好き」なのであって、「HipHop(<small>音楽や他の要素</small>)」をあまり深く知ろうとはしません。
            </p>
            <p>
            ...
            <p>
                それからというもの、週末になるとレコード店へ足を運んでは新譜をチェックしたり、(<small><span class="red-text">※</span>レコード店少なくなりましたが...現在ではAppleMusicなどでしょうか？</small>)音楽の本を読んでみたり、アーティストや、自分が踊りたくなるトラックを作るプロデューサーを探してみたり、たくさん知らなかったことを勉強するようになりました。
            </p>
            <p>
