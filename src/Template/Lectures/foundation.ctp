...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            ...
            <p>
                現在では一つの動きにもかなりの量があって最初の内は戸惑うかもしれません。ですが、基を辿れば基礎のバリエーションも少なく、シンプルに考えることができます。情報過多になっている現在では原点をベースに考え、練習するようにした方が良いでしょう。
            </p>
            <p>
            ...
            <p>
                突き詰める対象はもう言うまでもないかもしれませんが、ストリートダンスの「基礎」です。例えば、ウェーブはどうしたら綺麗に見えるのか、試行錯誤してダンス基礎の軸から離れずに何万回でも練習すべきです。
            </p>
            <p>
                ポッピングにしても、打つ部位がたくさんありますし、打ち方にも種類があります。ですが、最初はたくさんの部位で打つ必要はありません。種類も気にしなくていいのです。一つずつ確実に打てるようにし、徐々に部位を増やしていくようにしましょう。
            </p>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">基礎の一つ一つは点として捉える。スキルの壁を越えていくことで、動きがつながり始めることに気づく。そこからの上達は早い。</li>
    </ul>
