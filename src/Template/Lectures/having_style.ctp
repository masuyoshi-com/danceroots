...
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <p class="deep-orange-text mb-4 font-bold">Have my own style</p>
    <hr>

    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ストリートダンサーとして最終目標の一つにしたい「自分のスタイル」。これは見えない時はとても難しく感じます。ですが、<strong class="font-weight-bold">自分の好きなものをより明確に、確固たるものとして、それと同時にダンス活動をしていくこと、人に認められていくこと</strong>で自然と見に付くもの。理屈はいらないと思います。
            </p>
            <p>
                有名なダンサー達は自分のスタイルを持っている人が多いです。それを見て、共感してくれる人がファンになり、イベントなどに足を運んでくれます。
            </p>
            <p>
                過程としては、好きな音楽とダンスにしっかりとアンテナを張っておけば、継続的にダンス活動していく中で、自然と自分がかっこいいと思うものを表現していくわけですから、少しずつ変化・改善され、自分色に近づいていきます。
            </p>
            <p>
            ...
            <p>
                筆者がダンスチームとしてリスペクトする判断として見ているのは、皆同じルーティンをしていても、それぞれが違う動きに見え、個性があるかどうかです。その方がチームとしてインパクトがあったり、「かっこいいことしてるな」と感じるケースが多いです。
            </p>
            <p>
                今のダンスチームによく見られる印象は「まとまり過ぎている」と感じます。それは皆ダンスが上手なので良いのですが、個性がないため印象に残らないのです。<br>
                <small><strong class="red-text">※</strong>コンテストではそれでも認められることも多いように思いますが、それは主観による。ここでは筆者の主観として書いています。</small>
            </p>
            <p>
            ...
            <p>
                ストリートダンサーとして、また、ダンスチームの成長を考える時にそうした事柄を大切にすれば、自分達だけのカラーが生まれるでしょう。
            </p>
        </div>
    </div>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">自分のスタイルが得られるかどうかはこだわりを伸ばすことで変わる。</li>
