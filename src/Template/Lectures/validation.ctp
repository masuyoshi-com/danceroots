<?php
    $this->assign('description',
        'ダンス中級者になる頃に、練習の一つとして取り入れたい事柄は「ルーティン・バリデーション」です。最初の内は何かをベースに考えていくことが重要です。何もない所からルーティンを生み出すことは中々良いものになりにくいでしょう。ルーティンにおいても数をこなしていくことで、より音楽に合った振付を考えることができる様になります。');
    $this->assign('title', 'ルーティン・バリデーションを考える');
?>
<div class="row mt-5">
</div>
<div class="jumbotron mt-4 pt-4 text-center">
    ...
    <h1 class="card-title h2-responsive mt-2"><strong>ルーティン・バリデーションを考える</strong></h1>
    <p class="purple-text mb-4 font-bold">Think about routine validation</p>
    <hr>

    <div class="d-flex justify-content-center">
        <div class="card-text text-left mb-3" style="max-width: 43rem;">
            <p>
                ストリートダンスの基礎練習を重ねていくと、徐々にバリデーションの多さに気付くと思います。バリデーションもある程度体に馴染ませるには時間と労力が必要ですが、それ以上の練習としてバリデーションを自分で考える様にしてみましょう。
            </p>
            <p>
            ...
            <p>
                ...
                自分のダンス色が出来ていきます。そうなれば、徐々に早い時間でダンスのバリデーションや、ルーティンを頭に浮かべることはできるようになるでしょう。
            </p>
            <p>
                参考<br>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">ダンス基礎のバリデーションもしっかりと体の軸ができるまで練習を続けること。</li>
        <li class="list-group-item">基礎を無理に変える必要はない。組み合わせを変えるだけでオリジナリティは増す。</li>
        <li class="list-group-item">ルーティンやバリデーションを考える場合、「何かをベース」にする方が良いものが出来やすい。</li>
    </ul>
