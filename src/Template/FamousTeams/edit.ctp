<?php $this->assign('title', '有名チームプロフィール編集')  ?>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="d-flex">
            ...
            <div class="ml-auto">
                <p class="m-0 grey-text"><small>有名チームプロフィール編集</small></p>
            </div>
        </div>
        <hr class="mt-0">
    </div><!-- /.col-lg-12 -->
...
<div class="row mb-3">
    ...
    <div class="col-lg-12">
        <?= $this->Form->button(__('<i class="fa fa-edit mr-2" aria-hidden="true"></i>編集'), ['class' => 'btn btn-primary btn-block']) ?>
    </div>
</div><!-- /.row -->
<?= $this->Form->end() ?>
