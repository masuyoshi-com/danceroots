                ...
                <div class="col-lg-12">
                    <div class="wow fadeInUp">
                        ...
                        <p>
                            ...
                            <?php
                                if ($famousDancer->user_id !== $logins['id']) {
                                    ...
                                    print $this->Html->link('Home',
                                        ['controller' => 'FamousDancers', 'action' => 'home'],
...
<div class="container-fluid mt-3" style="background-color: #323438;">
                        ...
                        <p class="text-right m-0 mb-3">
                            <small>
                                <?= $this->Html->link('さらに見る<i class="fa fa-angle-right ml-2" aria-hidden="true"></i>',
                                        ['controller' => 'FamousEvents', 'action' => 'view', $famousDancer->user->username],
                                        ['escape' => false]
                                ) ?>
                            </small>
                        </p>
                    ...
                    <?php
                        if ($musics !== 0) {
                            print $this->Html->link('<i class="fa fa-music white-text mr-2" aria-hidden="true"></i>MUSIC',
                                ['controller' => 'FamousDancers', 'action' => 'music', $famousDancer->user->username],
                    ...
                    <?php
                        if ($videos !== 0) {
                            print $this->Html->link('<i class="fa fa-youtube-play mr-2" aria-hidden="true"></i><span class="none">Dance </span>Video',
                                ['controller' => 'FamousDancers', 'action' => 'video', $famousDancer->user->username],
...
<div class="container-fluid">
    <div class="card card-body grey lighten-3 mb-3">
        <div class="row">
...
<?php if ($famousDancer->facebook || $famousDancer->twitter || $famousDancer->instagram) : ?>
                ...
                <div class="footer-socials flex-center">
                    <?php
                        if ($famousDancer->facebook) {
                            print $this->Html->link('<i class="fa fa-facebook"></i>', $famousDancer->facebook,
                                [
                                    'class'  => 'btn-floating grey',
                                    'target' => '_blank',
                                    'escape' => false
                                ]);
                        }
                    ...
                    <?php
                        if ($famousDancer->twitter) {
                            print $this->Html->link('<i class="fa fa-twitter"></i>', $famousDancer->twitter,
                                [
                                    'class'  => 'btn-floating grey',
                                    'target' => '_blank',
                                    'escape' => false
                    ...
                    <?php
                        if ($famousDancer->instagram) {
                            print $this->Html->link('<i class="fa fa-instagram"></i>', $famousDancer->instagram,
                                [
                                    'class'  => 'btn-floating grey',
                                    'target' => '_blank',
                                    'escape' => false
