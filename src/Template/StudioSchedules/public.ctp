<?php $this->assign('title', '公開スタジオレッスンスケジュール'); ?>
...
<div class="row mt-3">
    <div class="col-lg-12">
        <div class="jumbotron text-center text-md-left author-box pt-3 pb-3">
                            ...
                            <?php if ($times[$i] === $suns[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($suns[$times[$i]]['start']) ?> ～ <?= h($suns[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
                            ...
                            <?php if ($times[$i] === $mons[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($mons[$times[$i]]['start']) ?> ～ <?= h($mons[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
                            ...
                            <?php if ($times[$i] === $tues[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($tues[$times[$i]]['start']) ?> ～ <?= h($tues[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
                            ...
                            <?php if ($times[$i] === $weds[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($weds[$times[$i]]['start']) ?> ～ <?= h($weds[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
                            ...
                            <?php if ($times[$i] === $thus[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($thus[$times[$i]]['start']) ?> ～ <?= h($thus[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
                            ...
                            <?php if ($times[$i] === $fris[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($fris[$times[$i]]['start']) ?> ～ <?= h($fris[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
                            ...
                            <?php if ($times[$i] === $sats[$times[$i]]['start']) : ?>
                                ...
                                <?php endif; ?>
                                    <div class="card card-body">
                                        ...
                                        <p class="m-0">
                                            <small>
                                                <?= h($sats[$times[$i]]['start']) ?> ～ <?= h($sats[$times[$i]]['end']) ?>
                                            </small>
                                        </p>
