<?php $this->assign('title', $famous_team->name . 'メンバー登録') ?>
        ...
        <div class="d-flex">
            <div>
                <h5 class="h5-responsive font-weight-bold">
                    <span class="none">Famous</span> Team Member<i class="fa fa-plus pink-text ml-2" aria-hidden="true"></i>
                </h5>
            </div>
            <div class="ml-auto">
                <p class="m-0 grey-text"><small>有名チームメンバー登録</small></p>
            </div>
        </div>
        <hr class="mt-0 mb-1">
