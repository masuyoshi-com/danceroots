<?php $this->assign('title', 'ダンスルーツ編集'); ?>
        ...
        <div class="d-flex">
            <div>
                <h5 class="h5-responsive font-weight-bold">
                    Dance R<span class="font-blue">oo</span>ts<i class="fa fa-pencil pink-text ml-2" aria-hidden="true"></i>
                </h5>
            </div>
            <div class="ml-auto">
                <p class="m-0 grey-text"><small>ダンスルーツ編集</small></p>
            </div>
        </div>
        <hr class="mt-0 mb-1">
