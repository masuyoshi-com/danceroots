                    ...
                    <div class="col-lg-12">
                        <div class="wow fadeInUp">
                            ...
                            <p>
                                ...
                                <?= $this->Html->link('BACK', ['controller' => 'FamousDancers', 'action' => 'view', '#' => 'roots', $user->username], ['class' => 'btn btn-outline-warning wow fadeIn']) ?>
                            </p>
                        </div>
                    </div><!-- /.col-lg-12-->
                </div><!-- /.row -->
                ...
                <div class="row smooth-scroll">
                    <div class="col-lg-12">
                        <div class="white-text text-center">
                            ...
                            <a href="#roots" class="btn btn-outline-info wow fadeIn" data-wow-delay="0.4s">ROOTS</a>
                            <?= $this->Html->link('BACK', ['controller' => 'FamousTeams', 'action' => 'view', '#' => 'roots', $user->username], ['class' => 'btn btn-outline-white wow fadeIn']) ?>
                        </div>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
