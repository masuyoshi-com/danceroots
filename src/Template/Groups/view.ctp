    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Register Flag') ?></th>
                <th scope="col"><?= __('Tmp Hash') ?></th>
                <th scope="col"><?= __('Injustice Count') ?></th>
            ...
            <tr>
                ...
                <td><?= h($users->classification) ?></td>
                <td><?= h($users->register_flag) ?></td>
                <td><?= h($users->tmp_hash) ?></td>
                <td><?= h($users->injustice_count) ?></td>
