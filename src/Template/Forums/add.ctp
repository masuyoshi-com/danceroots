        ...
        <div class="d-flex">
            <div>
                <h5 class="h5-responsive font-weight-bold">
                    <i class="fa fa-comments cyan-text" aria-hidden="true"></i> Dance Forum Thread <i class="fa fa-plus pink-text" aria-hidden="true"></i>
                </h5>
            </div>
            <div class="ml-auto">
                <p class="m-0 grey-text"><small>スレッド登録</small></p>
            </div>
        </div>
        <hr class="mt-0">
    </div><!-- /.col-lg-12 -->
...
<div class="row mt-4 mb-3">
    ...
    <div class="col-lg-8 col-md-6 col-xs-12">
        <div class="card card-body">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <?= $this->Form->button(__('<i class="fa fa-plus mr-2" aria-hidden="true"></i>スレッド登録'),
